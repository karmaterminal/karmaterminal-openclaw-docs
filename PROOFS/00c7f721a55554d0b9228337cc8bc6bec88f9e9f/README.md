...
Target presentation SHA: `00c7f721a55554d0b9228337cc8bc6bec88f9e9f`.
Immediate source presentation:
`d451ef74009f667bcdd58239c7d8a1d8c5a2a9b9`.
...
This is a self-contained transposition of the branch-local
`PROOFS/d451ef74009f667bcdd58239c7d8a1d8c5a2a9b9/` subtree at docs commit
`e2b3c19ffd6314ad521806faa09163eb54c75f92`. Corpus identity and navigation
are rebound to `00c7f721a55554d0b9228337cc8bc6bec88f9e9f`;
...
`d451ef74...`; the test-only commit makes the schema-v18 registry fixture use
the schema constant and gives the persisted fixed-store usage test explicit
ownership of its physical-file-resolution mock.
...
- Live rows are historical execution-composite evidence, not exact-00c7f721
  execution claims.
- Mode-B run 33165923171 belongs to grandparent product 4c3314f7 and is
  historical immediate-lineage evidence, not exact-target evidence.
