...
**Seat-side half now 5/6** (elliott + silas + emeric + ronan + rune; only 🩸 cael's seat-side card pending — his external-observer card is in figs's fan-out at 50%). Build-uniform `(077b261)` + continuation-substrate rendering confirmed on every seat-side card, across 3 x86 (elliott-legion, emeric-nuc, rune-rog-ally) + 1 arm64 (ronan-dgx) = **arch-independent on the deployed tip**.
