# R-CD-10: delegate error isolation — parent survives delegate failure

**Family**: `continue_delegate()`
**Lead Prince**: 🌊 Ronan
**Status**: ⏳ TO FIRE on `0dff94dbe48`
**Prior baseline**: see [`PROOFS/335acbe43a/R-CD-10/proof.md`](../../335acbe43a/R-CD-10/) — feature-byte-identical, scenario substrate can be cribbed verbatim then re-fired
