# R-CD-11: non-existent targetSessionKey → graceful fallback to dispatcher

**Family**: `continue_delegate(targetSessionKey=<bad>)`
**Lead Prince**: 🌊 Ronan
**Status**: ⏳ TO FIRE on `0dff94dbe48`
**Prior baseline**: see [`PROOFS/335acbe43a/R-CD-11/proof.md`](../../335acbe43a/R-CD-11/) — feature-byte-identical, scenario substrate can be cribbed verbatim then re-fired
