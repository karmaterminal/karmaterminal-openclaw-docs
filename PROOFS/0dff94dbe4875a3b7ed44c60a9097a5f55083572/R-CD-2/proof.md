# R-CD-2: silent return + wake to parent

**Family**: `continue_delegate(mode=silent-wake)`
**Lead Prince**: 🌊 Ronan
**Status**: ⏳ TO FIRE on `0dff94dbe48`
**Prior baseline**: see [`PROOFS/335acbe43a/R-CD-2/proof.md`](../../335acbe43a/R-CD-2/) — feature-byte-identical, scenario substrate can be cribbed verbatim then re-fired
