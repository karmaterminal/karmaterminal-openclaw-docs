# R-CD-3: delayed dispatch

**Family**: `continue_delegate(delaySeconds=10)`
**Lead Prince**: 🌊 Ronan
**Status**: ⏳ TO FIRE on `0dff94dbe48`
**Prior baseline**: see [`PROOFS/335acbe43a/R-CD-3/proof.md`](../../335acbe43a/R-CD-3/) — feature-byte-identical, scenario substrate can be cribbed verbatim then re-fired
