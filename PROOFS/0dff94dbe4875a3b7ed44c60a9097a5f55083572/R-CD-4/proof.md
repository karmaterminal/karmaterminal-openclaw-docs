# R-CD-4: cross-session routing

**Family**: `continue_delegate(targetSessionKey)`
**Lead Prince**: 🌊 Ronan
**Status**: ⏳ TO FIRE on `0dff94dbe48`
**Prior baseline**: see [`PROOFS/335acbe43a/R-CD-4/proof.md`](../../335acbe43a/R-CD-4/) — feature-byte-identical, scenario substrate can be cribbed verbatim then re-fired
