# R-CD-5: scheduling (event-coupled lifecycle)

**Family**: `continue_delegate(mode=post-compaction)`
**Lead Prince**: 🌊 Ronan
**Status**: ⏳ TO FIRE on `0dff94dbe48`
**Prior baseline**: see [`PROOFS/335acbe43a/R-CD-5/proof.md`](../../335acbe43a/R-CD-5/) — feature-byte-identical, scenario substrate can be cribbed verbatim then re-fired
