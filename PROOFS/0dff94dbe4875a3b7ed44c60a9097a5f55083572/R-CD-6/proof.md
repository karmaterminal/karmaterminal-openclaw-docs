# R-CD-6: parallel fan-out — 1-per-turn enforcement (expected FINDING)

**Family**: `continue_delegate() x N`
**Lead Prince**: 🌊 Ronan
**Status**: ⏳ TO FIRE on `0dff94dbe48`
**Prior baseline**: see [`PROOFS/335acbe43a/R-CD-6/proof.md`](../../335acbe43a/R-CD-6/) — feature-byte-identical, scenario substrate can be cribbed verbatim then re-fired
