# R-CD-7: broadcast routing

**Family**: `continue_delegate(fanoutMode=tree)`
**Lead Prince**: 🌊 Ronan
**Status**: ⏳ TO FIRE on `0dff94dbe48`
**Prior baseline**: see [`PROOFS/335acbe43a/R-CD-7/proof.md`](../../335acbe43a/R-CD-7/) — feature-byte-identical, scenario substrate can be cribbed verbatim then re-fired
