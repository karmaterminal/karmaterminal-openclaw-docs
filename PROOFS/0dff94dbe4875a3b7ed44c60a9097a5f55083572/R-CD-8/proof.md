# R-CD-8: explicit user-supplied traceparent override accepted + propagated

**Family**: `continue_delegate(traceparent=...)`
**Lead Prince**: 🌊 Ronan
**Status**: ⏳ TO FIRE on `0dff94dbe48`
**Prior baseline**: see [`PROOFS/335acbe43a/R-CD-8/proof.md`](../../335acbe43a/R-CD-8/) — feature-byte-identical, scenario substrate can be cribbed verbatim then re-fired
