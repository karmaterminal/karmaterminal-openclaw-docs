# R-CD-9: fire-and-forget (no wake, no channel)

**Family**: `continue_delegate(mode=silent)`
**Lead Prince**: 🌊 Ronan
**Status**: ⏳ TO FIRE on `0dff94dbe48`
**Prior baseline**: see [`PROOFS/335acbe43a/R-CD-9/proof.md`](../../335acbe43a/R-CD-9/) — feature-byte-identical, scenario substrate can be cribbed verbatim then re-fired
