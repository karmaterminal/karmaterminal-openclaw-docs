# R-CW-1: basic wake (10s delay)

**Family**: `continue_work()`
**Lead Prince**: 🩸 Cael
**Status**: ⏳ TO FIRE on `0dff94dbe48`
**Prior baseline**: see [`PROOFS/335acbe43a/R-CW-1/proof.md`](../../335acbe43a/R-CW-1/) — feature-byte-identical, scenario substrate can be cribbed verbatim then re-fired
