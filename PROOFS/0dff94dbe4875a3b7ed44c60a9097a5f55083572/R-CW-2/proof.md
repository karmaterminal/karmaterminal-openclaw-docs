# R-CW-2: delaySeconds=0 clamped to minDelayMs/1000=5s

**Family**: `continue_work(delaySeconds=0)`
**Lead Prince**: 🩸 Cael
**Status**: ⏳ TO FIRE on `0dff94dbe48`
**Prior baseline**: see [`PROOFS/335acbe43a/R-CW-2/proof.md`](../../335acbe43a/R-CW-2/) — feature-byte-identical, scenario substrate can be cribbed verbatim then re-fired
