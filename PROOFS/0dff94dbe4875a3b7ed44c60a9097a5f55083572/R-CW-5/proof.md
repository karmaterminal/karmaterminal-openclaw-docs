# R-CW-5: cost cap exhaustion → structured reject (NEEDS gateway restart w/ low costCapTokens)

**Family**: `continue_work()`
**Lead Prince**: 🩸 Cael
**Status**: ⏳ TO FIRE on `0dff94dbe48`
**Prior baseline**: see [`PROOFS/335acbe43a/R-CW-5/proof.md`](../../335acbe43a/R-CW-5/) — feature-byte-identical, scenario substrate can be cribbed verbatim then re-fired
