# R-CW-6: chain depth at boundary → structured reject (NEEDS restart w/ low maxChainLength)

**Family**: `continue_work()`
**Lead Prince**: 🩸 Cael
**Status**: ⏳ TO FIRE on `0dff94dbe48`
**Prior baseline**: see [`PROOFS/335acbe43a/R-CW-6/proof.md`](../../335acbe43a/R-CW-6/) — feature-byte-identical, scenario substrate can be cribbed verbatim then re-fired
