# R-CW-7: traceparent propagation end-to-end (architectural, OTel-layer)

**Family**: `continue_work()`
**Lead Prince**: 🩸 Cael
**Status**: ⏳ TO FIRE on `0dff94dbe48`
**Prior baseline**: see [`PROOFS/335acbe43a/R-CW-7/proof.md`](../../335acbe43a/R-CW-7/) — feature-byte-identical, scenario substrate can be cribbed verbatim then re-fired
