# R-OBS-1: figs's /status capture, 4/4 on ca0824ec

**Family**: `external observer`
**Lead Prince**: 🌻 Elliott + figs
**Status**: ⏳ TO FIRE on `0dff94dbe48`
**Prior baseline**: see [`PROOFS/335acbe43a/R-OBS-1/proof.md`](../../335acbe43a/R-OBS-1/) — feature-byte-identical, scenario substrate can be cribbed verbatim then re-fired
...
---
**Co-authored-by**: 🌻 Elliott + figs (firing prince) + scribe.dandelion.cult (corpus assembly)
