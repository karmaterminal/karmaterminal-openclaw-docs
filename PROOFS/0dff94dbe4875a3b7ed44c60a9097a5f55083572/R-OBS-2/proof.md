# R-OBS-2: trace tree visualization (UI cross-walk artifact)

**Family**: `Tempo UI`
**Lead Prince**: 🌻 Elliott
**Status**: ⏳ TO FIRE on `0dff94dbe48`
**Prior baseline**: see [`PROOFS/335acbe43a/R-OBS-2/proof.md`](../../335acbe43a/R-OBS-2/) — feature-byte-identical, scenario substrate can be cribbed verbatim then re-fired
