# R-CD-MODEL-DEFAULT — k6 live candidate receipt (Cael)
...
- k6 exit code: `0`
- runner started at: `2026-07-08T13:55:33Z`
- nonce: `R-CD-MODEL-DEFAULT-1783518933089-haz30kb3`
- disposable session: `agent:main:r-cd-model-default-r-cd-model-default-1783518933089-haz30kb3`
- `dispatch_accepted`: `True`
- `session_created`: `True`
- `parent_model_byte`: `github-copilot/gpt-5.5`
- `child_model_byte`: `github-copilot/gpt-5.5`
- `model_matches`: `True`
- `return_payload`: `True`
- emitted trace id: `null` / not emitted by the scenario receipt
- Tempo breadcrumb search: window `1783518873`–`1783519233`, candidates `46`, nonce matches `0`
