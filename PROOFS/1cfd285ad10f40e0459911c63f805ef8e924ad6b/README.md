...
The current assembly-backmerge tip is `1cfd285ad10f40e0459911c63f805ef8e924ad6b` (commit: "fix(ci): resolve lint/types/deadcode trivials on bd4276c813"). This is `bd4276c813` + 3 test/lint/deadcode-allowlist fixes — all test-only, **runtime byte-identical** to `bd4276c813` on every code path.
