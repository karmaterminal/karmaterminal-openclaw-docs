# OpenClaw proof corpus — 1fb5b8c9cdb0c2e64b1a31a6644791c2140ed986

Candidate: `OpenClaw 2026.6.11 (1fb5b8c)` transposed from the Cael live-fire corpus at `bca2b0b89ab886bf23a10e4983926f6b374b3188`.

Status: **COMPLETE / TRANSPOSED**. Current rollup: 25 pass / 1 partial / 1 thin / 1 honest_limit / 0 missing. The proof board is populated in Project 83 from the prior Project 82 row template. Rows start as `missing` until Cael + frond-scribe agree the exact test form, fire the row, capture receipts, and attach the required Tempo JSON where applicable.

## Transposition receipt

- Carried-from live-fire SHA: `bca2b0b89ab886bf23a10e4983926f6b374b3188`
- Transposed candidate SHA: `1fb5b8c9cdb0c2e64b1a31a6644791c2140ed986`
- Safe backmerge branch: `scribe/20260704/assembly-upstream-drift-backmerge`
- Gate 2.7 frozen-wall: exit 0, 0 FROZEN-STALE; mixed-clobber queue inspected with focused continuation/subagent/embedded-runner tests.
- Gate 2.5 differing upstream-touched tests: targeted set passed; upstream-deleted rows are absent in candidate too.
...
- Gate logs: `PROOFS/1fb5b8c9cdb0c2e64b1a31a6644791c2140ed986/gates/`

## Deployment receipt

- Assembly branch: `frond-scribe/20260624/assembly-continuation-followons`
- Candidate SHA: `1fb5b8c9cdb0c2e64b1a31a6644791c2140ed986` (transposed from live-fire `bca2b0b89ab886bf23a10e4983926f6b374b3188`)
