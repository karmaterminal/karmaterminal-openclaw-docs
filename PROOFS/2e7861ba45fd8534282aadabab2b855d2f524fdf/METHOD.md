# Method — Project 81 exact-2e7861 proof cycle

## Identity

- **Assembly / proof SHA:** `2e7861ba45fd8534282aadabab2b855d2f524fdf`
- **Assembly branch:** `scribe/20260712/1172-a177-upstream-absorb`
- **Immediate prior corpus:** `4afd560feb5102627a68a2f6a8bc545dabcfcfdc`
...
3. Run bounded assigned rows only after the fresh exact-SHA ledger is posted.
   Do not carry exact-`4afd560` continuation-tool results across this repair.
