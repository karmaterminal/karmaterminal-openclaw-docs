...
| Role | SHA / receipt |
|---|---|
| Target presentation / upstream PR #129388 head | `446f4b22d321cb7f5f26a4fbc2247f54da72d2a4` |
| Immediate source presentation / corpus | `4737afdf7dcc5cca53f8dd1bdaaeaa122ce17bbd` |
...
| Latest source-corpus docs update | `0e75318a68d7145c0c5b99e8b11bda304f4f9fd2` |
...
`failure`; it is source ancestry/materiality evidence, not exact-446f
acceptance. Current target upstream CI is pending and is not folded here.
