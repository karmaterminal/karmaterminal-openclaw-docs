# PROOFS / 4afd560feb5102627a68a2f6a8bc545dabcfcfdc

Active Project 81 corpus for the exact #1172 assembly SHA
`4afd560feb5102627a68a2f6a8bc545dabcfcfdc` (`OpenClaw 2026.7.2`).
...
1. Exact runtime identity showing full SHA
   `4afd560feb5102627a68a2f6a8bc545dabcfcfdc`.
...
5. Run:
   ...
   node tools/k6-proofs/scripts/validate-corpus.mjs \
     --sha 4afd560feb5102627a68a2f6a8bc545dabcfcfdc
   ```
