...
- Immediate source docs commit and canonical docs main:
  `1d023b1b9e48edcb409ddceda8988532ef1efc7d`.
...
- Product ancestry is exact: target `4c3314f7...` descends from source
  `4f85d997...`; accepted covenant checkpoint `c2aef217...` is the first
  absorb ancestor; target merge parents are `f04d8fcf...` and `df905a6c...`;
  and `f04d8fcf...` has parents `c2aef217...` and `f7e5add4...`.
