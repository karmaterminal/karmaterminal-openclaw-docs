...
Target presentation SHA: `4f85d9974f6b9b180dc2304fdf672bbca154da66`.
Immediate source presentation:
`c3fc615a868dcbfcf2be38e39683a25af737270c`.
...
source presentation; neither the source nor target presentation is an ancestor of the
historical execution composite.

## Transposition

This is a self-contained transposition of the canonical
`PROOFS/c3fc615a868dcbfcf2be38e39683a25af737270c/` subtree. The four
observability/harness research rows from that source remain available in the
historical source corpus and Git history, but are not PR #129388 feature
acceptance contracts and are not part of this active target. Corpus identity
and navigation are rebound to
`4f85d9974f6b9b180dc2304fdf672bbca154da66`; all retained row evidence and
vendored artifacts remain local to this target subtree. Historical execution
identities, verdicts, review states, timestamps, receipts, payloads, and
...
Exact-target upstream product CI, including run `33130949624` and exact-head
fanout, is active separately and has not yet been folded into this corpus.
...
`R-CD-TOKEN`, and `R-CW-6` remain partial, and `R-RC-2` remains the sole honest
limit. Zero fail and zero missing do not make the target complete or green.

## Honest limits

- Live rows are historical execution-composite evidence, not exact-4f85d997 execution claims.
- Exact-4737 Mode-B is historical source evidence; no exact-4f85d997 Mode-B was run.
- Exact-target upstream CI, including run `33130949624` and exact-head fanout, is active separately and has not yet been folded as corpus evidence.
