...
## Method (live capture on `7992640e60`)
...
**Tool form:**
```
continue_work(delaySeconds=8, reason="RCW3-TOOL-V2 reason-field OTel cross-walk 7992640e60 reason.preview capture")
```
...
```json
{ "name": "continuation.work",      "reason.preview": "RCW3-TOOL-V2 reason-field OTel cross-walk 7992640e60 reason.preview capture" }
{ "name": "continuation.work.fire", "reason.preview": "RCW3-TOOL-V2 reason-field OTel cross-walk 7992640e60 reason.preview capture" }
```
...
cross-walk certified live on `7992640e60`, both forms.
