# R-CW-4: chain-sequential — chain-counter decrements monotonically under constant chain.id at ship-SHA 7992640e60

**Family**: `continue_work()` chain counting (depth)
**Lead Prince**: 🩸 Cael
**Seat**: cael (🩸), DGX Spark GB10 ARM64
**Build**: OpenClaw 2026.6.2 (e66dc63) — running gateway `7992640e60`, Main PID 3238078, restarted 2026-06-08 07:16 PDT.
...
continue_work(delaySeconds=5, reason="R-CW-1 cure/continuation PROOF fire at ship-SHA 7992640e60 ...")
# hop B (R-CW-4 turn 2/3)
continue_work(delaySeconds=5, reason="R-CW-4 chain-3-sequential turn 2/3 PROOF at 7992640e60 ...")
# hop C (R-CW-4 turn 3/3)
continue_work(delaySeconds=5, reason="R-CW-4 chain-3-sequential turn 3/3 PROOF at 7992640e60 ...")
```
