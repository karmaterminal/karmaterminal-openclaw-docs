# R-CW-TOKEN: continue_work bracket/token form (CONTINUE_WORK:N) at ship-SHA 7992640e60

**Family**: `continue_work()` — token/bracket fallback path (both-forms mandate)
**Lead Prince**: 🩸 Cael
**Seat**: cael (🩸), DGX Spark GB10 ARM64
**Build**: OpenClaw 2026.6.2 (e66dc63) — gateway `7992640e60`
...
- Sibling execution proof: Rune R-CW-DELEGATE-TOKEN (same SHA `7992640e60`).
