# R-CW-TOKEN: continue_work bracket/token form (CONTINUE_WORK:N) at ship-SHA 1cfd285ad1
...
- Sibling execution proof: Rune R-CW-DELEGATE-TOKEN (same SHA `1cfd285ad1`).
