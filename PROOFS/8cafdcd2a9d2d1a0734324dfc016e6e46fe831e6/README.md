...
**Genuinely MISSING entirely:** `gates/` · `cure-bytes/` · R-CD-3 · R-CD-4 · R-RC-1 _(README.md + RESOLVED-SHA.md present)_. _(2026-06-17 ~04:05 PDT update: 🩸 Cael filled R-CW-1 [`8e02237`], R-CW-4, R-CW-5 to standard on the deployed `8cafdcd`; R-CW-TOKEN is PARTIAL [PARSE proven fresh, hop-2 EXECUTION carried by exemplar, fresh-`8cafdcd` execution owed]; R-RC-2 filed HONEST-PENDING on cael-seat with cross-seat ACCEPT carrying the mechanism.)_
