...
## Method (live capture on `ae5e01e76f`)
...
**Tool form:**
```
continue_work(delaySeconds=8, reason="RCW3-TOOL-V2 reason-field OTel cross-walk ae5e01e76f reason.preview capture")
```
...
```json
{ "name": "continuation.work",      "reason.preview": "RCW3-TOOL-V2 reason-field OTel cross-walk ae5e01e76f reason.preview capture" }
{ "name": "continuation.work.fire", "reason.preview": "RCW3-TOOL-V2 reason-field OTel cross-walk ae5e01e76f reason.preview capture" }
```
...
cross-walk certified live on `ae5e01e76f`, both forms.
