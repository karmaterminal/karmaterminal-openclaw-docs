# R-CW-DELEGATE-SELF-CONTINUATION — evidence at `b27a262`

- **verdict:** `PASS-candidate`
- **scenario:** `r-cw-delegate-self-continuation`
...
`cael/20260809T191051Z-r-cw-delegate-self-continuation-7f675e5a/`
