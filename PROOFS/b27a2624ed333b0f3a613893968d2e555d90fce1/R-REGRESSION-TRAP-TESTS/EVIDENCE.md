# R-REGRESSION-TRAP-TESTS — evidence at `b27a262`

- **verdict:** `FAIL-candidate`
- **scenario:** `r-regression-trap-tests`
...
`cael/20260809T191756Z-r-regression-trap-tests-7f675e5a/`
- `candidate-run-result-validation.error.log`
- `candidate-run-result-validation.json`
- `evidence-extraction.error.log`
- `evidence-extraction.json`
- `evidence-lines.log`
- `evidence-redaction.error.log`
