...
Offline source/harness contract check for R-CW-5; cannot establish live cap exhaustion. Not executed in run 32231533500; retained as an explicit missing row for refinement.

## Evidence

- [`tools/k6-proofs/manifests/r-cw-5a-static.json`](../../../tools/k6-proofs/manifests/r-cw-5a-static.json)
