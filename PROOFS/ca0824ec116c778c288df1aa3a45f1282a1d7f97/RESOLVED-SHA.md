# RESOLVED-SHA: `ca0824ec116c778c288df1aa3a45f1282a1d7f97`
...
- **Candidate SHA**: `ca0824ec116c778c288df1aa3a45f1282a1d7f97`
...
| 4 | `ca0824ec11` | ✅ VERIFIED CANONICAL | cohort consolidation post-substrate-walk |
...
| 2. Rebase | ✅ | 10→2 conflicts resolved across iteration; final `ca0824ec11` has semantic-fix (`run-keep-survives-ttl` adopting upstream semantics) + lint fix (`?? []`) + `readSessionEntry` import preserved |
...
To populate after fleet-deploy + CI re-fire on `ca0824ec11`.
