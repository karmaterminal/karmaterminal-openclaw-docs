...
**Status**: ✅ PROVEN on `e66dc63f163b4cd4024e001ac8932f26b347ed27`
...
## Method (live capture on `e66dc63f`)

Seat confirmed on the candidate bytes: `git rev-parse HEAD` =
`e66dc63f163b4cd4024e001ac8932f26b347ed27`.
...
**Tool form:**
```
continue_work(delaySeconds=8, reason="RCW3-TOOL-V2 reason-field OTel cross-walk e66dc63f reason.preview capture")
```
...
```json
{ "name": "continuation.work",      "reason.preview": "RCW3-TOOL-V2 reason-field OTel cross-walk e66dc63f reason.preview capture" }
{ "name": "continuation.work.fire", "reason.preview": "RCW3-TOOL-V2 reason-field OTel cross-walk e66dc63f reason.preview capture" }
```
...
cross-walk certified live on `e66dc63f`, both forms.
