# Method — Project 81 5292 proof rerun transposed to ee9295c

## Scope

- **Safe assembly / corpus SHA:** `ee9295cc6bb4fb27b135c3c21252ef9e815e2766`
...
2. Seed `PROOFS/ee9295cc6bb4fb27b135c3c21252ef9e815e2766/` from the previous full-copy corpus so corpus-dependent rows have an addressable target.
...
7. During proof generation and PR-presentation preparation, absorb current upstream/main drift into the safe assembly branch, validate the touched non-proof-row drift slices, and full-copy transpose the 5292 corpus to push SHA `ee9295cc6bb4fb27b135c3c21252ef9e815e2766`. The final ee9295c drift batches were Android screenshot determinism, Codex app inventory diagnostic UTF-16 safety, Line/Matrix/Telegram inbound-log preview UTF-16 safety, auth-profile OAuth credential recovery, and docs-only infographic table formatting.
...
This corpus does not claim a second live gateway proof run at ee9295c. It preserves `proof_source_sha=5292af40d0ad5303b85a678f6e629503a8725848` and `proof_push_sha=ee9295cc6bb4fb27b135c3c21252ef9e815e2766` because the final drift corrections were freshness/ancestry take-backs that did not modify the continuation proof-row behavior under test.
