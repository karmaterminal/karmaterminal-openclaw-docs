# OpenClaw proof corpus — f08ec7d2ca414f7965a9ddad8ec0bc97a2ad1d55

Candidate: `OpenClaw 2026.6.11 (f08ec7d)` full-copy transposed from the Cael live-fire corpus at `bca2b0b89ab886bf23a10e4983926f6b374b3188`.

Status: **COMPLETE + supplemental #246 / FULL-COPY TRANSPOSED**. Current rollup: 27 pass / 0 partial / 1 thin / 1 honest_limit / 0 missing. The proof board was populated in Project 83 from the prior Project 82 row template. Raw row receipts were fired on `bca2b0b89ab886bf23a10e4983926f6b374b3188`; this full copied corpus carries them to `f08ec7d2ca414f7965a9ddad8ec0bc97a2ad1d55` for clawsweeper exact-SHA navigation after the `c9142c0` shard-green baseline, `openclaw-bootstrap#1263` aggregate fix, the `b22c36f` upstream/main drift absorb, the branch-owned plugin SDK wildcard budget correction, and the fresh `3f380635` upstream/main Swift/UI drift absorb.

## Transposition receipt

- Carried-from live-fire SHA: `bca2b0b89ab886bf23a10e4983926f6b374b3188`
- Transposed candidate SHA: `f08ec7d2ca414f7965a9ddad8ec0bc97a2ad1d55`
- Safe assembly branch: `scribe/20260704/assembly-upstream-drift-backmerge`
- Local targeted validation: `f08ec7d` passes `plugin-sdk-surface-report.test.ts`, `scripts/plugin-sdk-surface-report.mjs --check`, `docs:map:check`, `native-app-i18n check`, and `git diff --check`. The only `3f380635` merge conflict was `ChatMarkdownDisplayPreprocessorTests.swift`; it was resolved to upstream's current test shape because fenced/table handling moved to `ChatMarkdownBlockSegmenter`. PR-presenting branch not yet fast-forwarded at corpus transpose time.
- Review-only PR: `karmaterminal/openclaw#1163`
- Gate 2.7 frozen-wall: exit 0, 0 FROZEN-STALE; counts are 127 SAFE-NEW / 139 GENUINE / 88 MIXED-CLOBBER.
- Gate logs: `PROOFS/f08ec7d2ca414f7965a9ddad8ec0bc97a2ad1d55/gates/`
...
- Candidate SHA: `f08ec7d2ca414f7965a9ddad8ec0bc97a2ad1d55` (full-copy transposed from live-fire `bca2b0b89ab886bf23a10e4983926f6b374b3188`)
