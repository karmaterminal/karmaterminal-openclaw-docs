# Resolved SHA — f08ec7d2ca414f7965a9ddad8ec0bc97a2ad1d55
...
`f08ec7d2ca414f7965a9ddad8ec0bc97a2ad1d55`.

| Check | Receipt |
|---|---|
| Safe branch | `scribe/20260704/assembly-upstream-drift-backmerge` |
| Candidate SHA | `f08ec7d2ca414f7965a9ddad8ec0bc97a2ad1d55` |
| Carried-from live-fire SHA | `bca2b0b89ab886bf23a10e4983926f6b374b3188` |
| Build string | `OpenClaw 2026.6.11 (f08ec7d)` transposed from `OpenClaw 2026.6.11 (bca2b0b)` live-fire receipts |
| Review-only PR | `karmaterminal/openclaw#1163` |
| Local targeted validation | Upstream/main passes `plugin-sdk-surface-report.test.ts`; `f08ec7d` passes the exact failed test and `scripts/plugin-sdk-surface-report.mjs --check` after the wildcard budget-pin correction |
