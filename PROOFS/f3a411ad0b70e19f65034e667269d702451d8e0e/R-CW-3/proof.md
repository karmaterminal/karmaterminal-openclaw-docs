...
## Method (live capture on `f3a411ad`)
...
**Tool form:**
```
continue_work(delaySeconds=8, reason="RCW3-TOOL-V2 reason-field OTel cross-walk f3a411ad reason.preview capture")
```
...
```json
{ "name": "continuation.work",      "reason.preview": "RCW3-TOOL-V2 reason-field OTel cross-walk f3a411ad reason.preview capture" }
{ "name": "continuation.work.fire", "reason.preview": "RCW3-TOOL-V2 reason-field OTel cross-walk f3a411ad reason.preview capture" }
```
...
cross-walk certified live on `f3a411ad`, both forms.
