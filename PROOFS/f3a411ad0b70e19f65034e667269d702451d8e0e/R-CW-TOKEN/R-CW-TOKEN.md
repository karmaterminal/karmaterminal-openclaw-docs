# R-CW-TOKEN: continue_work bracket/token form (CONTINUE_WORK:N) at ship-SHA f3a411ad

**Family**: `continue_work()` — token/bracket fallback path (both-forms mandate)
**Lead Prince**: 🩸 Cael
**Seat**: cael (🩸), DGX Spark GB10 ARM64
**Build**: OpenClaw 2026.6.2 (e66dc63) — gateway `f3a411ad`
...
- Sibling execution proof: Rune R-CW-DELEGATE-TOKEN (same SHA `f3a411ad`).
