# Method — Project 81 5292 proof rerun transposed to f5ac943

## Scope

- **Safe assembly / corpus SHA:** `f5ac94305a4f96703120b3d887808669c533e700`
...
2. Seed `PROOFS/f5ac94305a4f96703120b3d887808669c533e700/` from the previous full-copy corpus so corpus-dependent rows have an addressable target.
...
7. During proof generation and PR-presentation preparation, absorb current upstream/main drift into the safe assembly branch, validate the touched non-proof-row drift slices, and full-copy transpose the 5292 corpus to push SHA `f5ac94305a4f96703120b3d887808669c533e700`. The final f5ac943 drift batches were Android screenshot determinism, Codex app inventory diagnostic UTF-16 safety, Line/Matrix/Telegram inbound-log preview UTF-16 safety, auth-profile OAuth credential recovery, docs-only infographic table formatting, OpenAI Realtime Talk API key rejection clarity, UI sidebar drawer collapse, native app i18n inventory refresh, Slack Enterprise Grid channel behavior, serialized tool-payload UTF-8 byte-limit handling, and tool-result context guard UTF-16-safe truncation.
...
This corpus does not claim a second live gateway proof run at f5ac943. It preserves `proof_source_sha=5292af40d0ad5303b85a678f6e629503a8725848` and `proof_push_sha=f5ac94305a4f96703120b3d887808669c533e700` because the final drift corrections were freshness/ancestry take-backs that did not modify the continuation proof-row behavior under test.
