# Method — Project 81 5292 proof rerun transposed to ffcfeee

## Scope

- **Safe assembly / corpus SHA:** `ffcfeee2dedebb2e8ba68be5c03efc8771aa15c3`
...
2. Seed `PROOFS/ffcfeee2dedebb2e8ba68be5c03efc8771aa15c3/` from the previous full-copy corpus so corpus-dependent rows have an addressable target.
...
7. During proof generation and PR-presentation preparation, absorb current upstream/main drift into the safe assembly branch, validate the touched non-proof-row drift slices, and full-copy transpose the 5292 corpus to push SHA `ffcfeee2dedebb2e8ba68be5c03efc8771aa15c3`. The final ffcfeee drift batches were Android screenshot determinism, Codex app inventory diagnostic UTF-16 safety, Line/Matrix/Telegram inbound-log preview UTF-16 safety, auth-profile OAuth credential recovery, docs-only infographic table formatting, OpenAI Realtime Talk API key rejection clarity, and UI sidebar drawer collapse.
...
This corpus does not claim a second live gateway proof run at ffcfeee. It preserves `proof_source_sha=5292af40d0ad5303b85a678f6e629503a8725848` and `proof_push_sha=ffcfeee2dedebb2e8ba68be5c03efc8771aa15c3` because the final drift corrections were freshness/ancestry take-backs that did not modify the continuation proof-row behavior under test.
