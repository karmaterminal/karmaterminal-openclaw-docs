...
|---|---|---|---|---|
| A1 | flow_runs + jsonl persistence across restart | Authored | **METHOD-BROKEN-by-timing** | round-1 fire 2026-05-08 nonce `A1-URUDYNE-20260508T1609PDT`: delegate dispatched naturally at T0+600s before restart-fire window completed; restart fired ~7min after natural-dispatch; row-spec PASS-criteria substrate-shifted before tested. Re-fire required per cohort-cosigned (c)+(b) path. Row-evidence: `swims/swim-44/rows/A1-flow-runs-persistence-across-restart-evidence.md` |
