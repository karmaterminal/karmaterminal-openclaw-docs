...
test('duplicate scheduling, interruption, typed-tool origin, and mismatched reason are non-PASS', () => {
  for (const overrides of [
    ...
    { evidence: { ...evidence, origin_return_event_count: 2 } },
    { evidence: { ...evidence, root_substituted_return_count: 1 } },
    { evidence: { ...evidence, origin_return_message_seq: 2 } },
