...
function evidenceDraft({ manifest, summary, result }) {
  ...
  const summaryDescription = manifest.rowId === 'R-CD-2'
    ? 'public-safe R-CD-2 aggregate summary; private k6 acquisition is withheld'
    : 'raw k6 summary/export';
...
- \`k6-summary.json\` — ${summaryDescription}.
