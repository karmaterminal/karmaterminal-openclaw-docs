...
export async function main(argv = process.argv, env = process.env) {
  ...
  const receipts = {
    'newest-drives': source.contract.tests.newestDrives && suite.ok,
    'within-grace-older-drives': source.contract.tests.withinGraceOlderDrives && suite.ok,
    'stale-queued-older-folds': source.contract.tests.staleQueuedOlderFolds && suite.ok,
    'running-never-folds': source.contract.tests.runningNeverFolds && suite.ok,
